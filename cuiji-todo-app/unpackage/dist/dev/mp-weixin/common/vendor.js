...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__E3092B4",
    appName: "cuiji-todo-app",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "待办事项管理应用",
